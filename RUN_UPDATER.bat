...
echo ========================================
echo.
echo [INFO] This will launch the updater in Anaconda/Miniconda Prompt
echo.
...
echo.
echo [INFO] Launching updater in Anaconda/Miniconda prompt...
echo [INFO] A new window will open. Please wait...
echo.

REM Launch the updater in Anaconda prompt
start "TTS Updater" /D "%cd%" "%windir%\System32\cmd.exe" /K ""%CONDA_ROOT%\Scripts\activate.bat" "%CONDA_ROOT%" && update.bat"

echo.
echo [INFO] The updater is running in the new window.
